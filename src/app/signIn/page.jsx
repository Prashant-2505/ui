...
import Link from 'next/link'; // Not used in the component
import { FcGoogle } from 'react-icons/fc'; // Not used in the component
...
const SignIn = () => {
  ...
  return (
    <div className='SignInDiv flex flex-col justify-between items-center h-full w-full pt-10'>
